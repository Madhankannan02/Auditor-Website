            ...
            <div className="container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center gap-12">
                ...
                >
                    ...
                    <p className="text-slate-300 mb-6 leading-relaxed">
                        With over a decade of experience, 'Grow High Auditing' has been a beacon of trust and reliability in the financial sector. We believe in building long-term relationships with our clients based on integrity, transparency, and results.
                    </p>
